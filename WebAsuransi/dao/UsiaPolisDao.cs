...
public class UsiaPolisDao : Dao, IDao
    {
        #region DAO
        ...
        {
            bool status = false;
            string strSQL = "Delete from tbusiapolis where id ='" + model.ToString() + "'";
        ...
        public bool Save(object model)
        {
            ...
            string strSQL = "Insert into tbusiapolis(id,katagori) values('" +
                                       arrs[0] + "','" + arrs[1] +  "')";
            status = SetQueryUpdateDatabase(strSQL);
        ...
        public bool Update(object model, string id)
        {
            ...
            try
            {
                ...
                string strSQL = "Update tbusiapolis " +
        ...
        public System.Collections.Generic.List<object> SelectAll()
        {
            ...
            try
            {
                ...
                string query = "select * from tbusiapolis order by id";
        ...
        public object SelectById(string id)
        {
            ...
            try
            {
                ...
                string query = "select * from tbusiapolis where id ='" + id + "' order by id";
                dt = GetQueryDatabase(query);
                lists = SetDataTableTolist(dt);
        ...
        public System.Collections.Generic.List<object> SelectByCriterias(System.Collections.ArrayList criterias)
        {
            ...
            try
            {
                ...
                string query = "select * from tbusiapolis where katagori like '%" +
        ...
        public string GetPrimaryKey()
        {
            ...
            string strTemp = "";
            string strValue = "";
            string strSQL = "Select id from tbusiapolis order by id desc";
