...
public class PekerjaanDao : Dao, IDao
    {
        #region DAO
        ...
        {
            bool status = false;
            string strSQL = "Delete from tbpekerjaan where id ='" + model.ToString() + "'";
        ...
        public bool Save(object model)
        {
            ...
            string strSQL = "Insert into tbpekerjaan(id,katagori) values('" +
                                       arrs[0] + "','" + arrs[1] +  "')";
            status = SetQueryUpdateDatabase(strSQL);
        ...
        public bool Update(object model, string id)
        {
            ...
            try
            {
                ...
                string strSQL = "Update tbpekerjaan " +
        ...
        public System.Collections.Generic.List<object> SelectAll()
        {
            ...
            try
            {
                ...
                string query = "select * from tbpekerjaan order by id";
        ...
        public object SelectById(string id)
        {
            ...
            try
            {
                ...
                string query = "select * from tbpekerjaan where id ='" + id + "' order by id";
                dt = GetQueryDatabase(query);
                lists = SetDataTableTolist(dt);
        ...
        public System.Collections.Generic.List<object> SelectByCriterias(System.Collections.ArrayList criterias)
        {
            ...
            try
            {
                ...
                string query = "select * from tbpekerjaan where katagori like '%" +
        ...
        public string GetPrimaryKey()
        {
            ...
            string strTemp = "";
            string strValue = "";
            string strSQL = "Select id from tbpekerjaan order by id desc";
