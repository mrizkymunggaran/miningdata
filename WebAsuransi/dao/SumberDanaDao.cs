...
public class SumberDanaDao : Dao, IDao
    {
        #region DAO
        ...
        {
            bool status = false;
            string strSQL = "Delete from tbsumberdana where id ='" + model.ToString() + "'";
        ...
        public bool Save(object model)
        {
            ...
            string strSQL = "Insert into tbsumberdana(id,katagori) values('" +
                                       arrs[0] + "','" + arrs[1] +  "')";
            status = SetQueryUpdateDatabase(strSQL);
        ...
        public bool Update(object model, string id)
        {
            ...
            try
            {
                ...
                string strSQL = "Update tbsumberdana " +
        ...
        public System.Collections.Generic.List<object> SelectAll()
        {
            ...
            try
            {
                ...
                string query = "select * from tbsumberdana order by id";
        ...
        public object SelectById(string id)
        {
            ...
            try
            {
                ...
                string query = "select * from tbsumberdana where id ='" + id + "' order by id";
                dt = GetQueryDatabase(query);
                lists = SetDataTableTolist(dt);
        ...
        public System.Collections.Generic.List<object> SelectByCriterias(System.Collections.ArrayList criterias)
        {
            ...
            try
            {
                ...
                string query = "select * from tbsumberdana where katagori like '%" +
        ...
        public string GetPrimaryKey()
        {
            ...
            string strTemp = "";
            string strValue = "";
            string strSQL = "Select id from tbsumberdana order by id desc";
