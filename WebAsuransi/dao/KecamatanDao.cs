...
public class KecamatanDao : Dao, IDao
    {
        #region DAO
        ...
        {
            bool status = false;
            string strSQL = "Delete from tbkecamatan where id ='" + model.ToString() + "'";
        ...
        public bool Save(object model)
        {
            ...
            string strSQL = "Insert into tbkecamatan(id,katagori) values('" +
                                       arrs[0] + "','" + arrs[1] +  "')";
            status = SetQueryUpdateDatabase(strSQL);
        ...
        public bool Update(object model, string id)
        {
            ...
            try
            {
                ...
                string strSQL = "Update tbkecamatan " +
        ...
        public System.Collections.Generic.List<object> SelectAll()
        {
            ...
            try
            {
                ...
                string query = "select * from tbkecamatan order by id";
        ...
        public object SelectById(string id)
        {
            ...
            try
            {
                ...
                string query = "select * from tbkecamatan where id ='" + id + "' order by id";
                dt = GetQueryDatabase(query);
                lists = SetDataTableTolist(dt);
        ...
        public System.Collections.Generic.List<object> SelectByCriterias(System.Collections.ArrayList criterias)
        {
            ...
            try
            {
                ...
                string query = "select * from tbkecamatan where katagori like '%" +
        ...
        public string GetPrimaryKey()
        {
            ...
            string strTemp = "";
            string strValue = "";
            string strSQL = "Select id from tbkecamatan order by id desc";
